...
create table item (id int8 not null, bn_price int4, description text, image varchar(255), name varchar(255) not null, price int4, url varchar(255), vendor varchar(255), category_id int8 not null, primary key (id));
